...
'organization_slug' => 'getOrganizationSlug'    ];
     ...
     * Sets access_token
     *
     * @param string $access_token The JWT token to use in future requests
     *
     * @return $this
     */
     ...
     * Sets expires_in
     *
     * @param string $expires_in Token expiration in seconds
     *
     * @return $this
     */
     ...
     * Sets refresh_token
     *
     * @param string $refresh_token Token used to refresh the token and get a new JWT token after expiration
     *
     * @return $this
     */
     ...
     *
     * @param string $organization_slug Slug identifying the created organization
     *
     * @return $this
     */
