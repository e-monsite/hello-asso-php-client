...
class AuthApi
{
     ...
     */
    public function auhtorize($client_id = null, $client_secret = null, $grant_type = null, $refresh_token = null, $user_email = null, $user_first_name = null, $user_last_name = null, $organization_name = null, $organization_address = null, $organization_zipcode = null, $organization_city = null, $organization_phone = null, $organization_type = null, $organization_website = null)
    {
        list($response) = $this->auhtorizeWithHttpInfo($client_id, $client_secret, $grant_type, $refresh_token, $user_email, $user_first_name, $user_last_name, $organization_name, $organization_address, $organization_zipcode, $organization_city, $organization_phone, $organization_type, $organization_website);
        return $response;
    }

    /**
     * Operation auhtorizeWithHttpInfo
     *
     * Authorization request
     *
     ...
     */
    public function auhtorizeWithHttpInfo($client_id = null, $client_secret = null, $grant_type = null, $refresh_token = null, $user_email = null, $user_first_name = null, $user_last_name = null, $organization_name = null, $organization_address = null, $organization_zipcode = null, $organization_city = null, $organization_phone = null, $organization_type = null, $organization_website = null)
    {
        $returnType = '\HelloAsso\Api\Model\AuthorizationResponse';
        $request = $this->auhtorizeRequest($client_id, $client_secret, $grant_type, $refresh_token, $user_email, $user_first_name, $user_last_name, $organization_name, $organization_address, $organization_zipcode, $organization_city, $organization_phone, $organization_type, $organization_website);
     ...
     */
    public function auhtorizeAsync($client_id = null, $client_secret = null, $grant_type = null, $refresh_token = null, $user_email = null, $user_first_name = null, $user_last_name = null, $organization_name = null, $organization_address = null, $organization_zipcode = null, $organization_city = null, $organization_phone = null, $organization_type = null, $organization_website = null)
    {
        return $this->auhtorizeAsyncWithHttpInfo($client_id, $client_secret, $grant_type, $refresh_token, $user_email, $user_first_name, $user_last_name, $organization_name, $organization_address, $organization_zipcode, $organization_city, $organization_phone, $organization_type, $organization_website)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation auhtorizeAsyncWithHttpInfo
     *
     * Authorization request
     *
     * @param  string $client_id (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function auhtorizeAsyncWithHttpInfo($client_id = null, $client_secret = null, $grant_type = null, $refresh_token = null, $user_email = null, $user_first_name = null, $user_last_name = null, $organization_name = null, $organization_address = null, $organization_zipcode = null, $organization_city = null, $organization_phone = null, $organization_type = null, $organization_website = null)
    {
        $returnType = '\HelloAsso\Api\Model\AuthorizationResponse';
        $request = $this->auhtorizeRequest($client_id, $client_secret, $grant_type, $refresh_token, $user_email, $user_first_name, $user_last_name, $organization_name, $organization_address, $organization_zipcode, $organization_city, $organization_phone, $organization_type, $organization_website);
    ...
    /**
     * Create request for operation 'auhtorize'
     *
     * @param  string $client_id (optional)
     * @param  string $client_secret (optional)
     * @param  string $grant_type (optional)
